...
public interface EventSequenceProducerHelpers {
	 ...
	 * @param sequence
	 * @param time
	 * il primo evento prodotto da sequence dopo time, o un optional empty se non esiste
	 ...
	 * @param sequence
	 * @param predicate
	 * EventSequenceProducer ottenuto da sequenza filtrando tutti gli eventi di cui il contenuto non supera il predicato
