...
public interface DecisionChainFactory {
	 ...
	 * @param negative
	 * 
	 * a decidere che se il predicato è passabile dall'input, poi esso delega a un altro decider che ritorna positivo
	 * altrimento delega a un altro decider che ritorna sempren egativo
